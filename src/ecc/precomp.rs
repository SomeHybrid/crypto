...
impl Precomp {
    pub const fn new(yplusx: [i32; 10], yminusx: [i32; 10], xy2d: [i32; 10]) -> Self {
        Precomp {
            yplusx: FieldElement::from(yplusx),
            yminusx: FieldElement::from(yminusx),
            xy2d: FieldElement::from(xy2d),
        }
    }
    ...
    pub fn cmov(&mut self, other: Precomp, swap: i32) {
        self.yplusx.cmov(other.yplusx, swap);
        self.yminusx.cmov(other.yminusx, swap);
        self.xy2d.cmov(other.xy2d, swap)
    }
}
